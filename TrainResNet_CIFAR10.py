...
from cntk.learners import nesterov, adam
from PGDescent import *
...
def train_and_evaluate(reader_train, reader_test, network_name, sgd_method, epoch_size, max_epochs, profiler_dir=None,
    ...
    if sgd_method == 'momentum_sgd':
        ...
        learner = adam(z.parameters, lr_schedule, mm_schedule,
                               l2_regularization_weight=l2_reg_weight)
    elif sgd_method == 'PGDescent':
        learner = PGDescent(z.parameters, lr_schedule, mm_schedule,
                            l2_regularization_weight=l2_reg_weight)
    else:
        return RuntimeError("Unknown descent method!")
...
if __name__=='__main__':
    ...
    parser.add_argument('-sgd', '--sgd_method', help='momentum_sgd, nesterov, adam or PGDescent', required=False, default='momentum_sgd')
    ...
    epoch_size = 50000
    train_and_evaluate(reader_train, reader_test, network_name, sgd_method, epoch_size, epochs, args['profiler_dir'], model_dir,
